  ...
  return (
    <div className="pList">
      ...
      <div className="pListItem">
        ...
        <div className="pListTitles">
          <h1>Apartments</h1>
          <h2>892 apartments</h2>
        </div>
      </div>
      <div className="pListItem">
        <img
          src="https://q-xx.bstatic.com/xdata/images/xphoto/300x240/45450075.jpeg?k=d23cf8443780ac09f46f59e40393d75dbe64b06029b4959c60b81b7fdefc9be0&o="
          alt=""
        />
        <div className="pListTitles">
          <h1>Self-catering Accommodations</h1>
          <h2>780 Self-catering Properties</h2>
        </div>
      </div>
      <div className="pListItem">
        <img
      ...
      <div className="pListItem">
        <img
          src="https://q-xx.bstatic.com/xdata/images/xphoto/300x240/45450066.jpeg?k=4adfab312f5d26da9f81da48d8c95ca8f108215b2c84085590891a9e0e17b144&o="
          alt=""
        />
        <div className="pListTitles">
          <h1>Homestays</h1>
      ...
      <div className="pListItem">
        <img
          src="https://r-xx.bstatic.com/xdata/images/xphoto/300x240/45450073.jpeg?k=795a94c30433de1858ea52375e8190a962b302376be2e68aa08be345d936557d&o="
          alt=""
        />
        <div className="pListTitles">
          <h1>Guest houses</h1>
          <h2>94 guest houses</h2>
        </div>
      </div>
    </div>
  );
